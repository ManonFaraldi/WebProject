...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 22 mars 2018 à 13:57
...
INSERT INTO `articles` (`ID_ART`, `AUTEUR_ART`, `TITRE_ART`, `CONTENU_ART`, `RESUME_ART`, `DATE_ART`) VALUES
(1, 'JJ Rousseau', 'Pulpa Colada', 'C''est les meilleurs votez pour eux', 'Votez pour eux !', '0000-00-00'),
(2, 'JJ Rousseau', 'Pulpa Colada2', 'C''est les meilleurs votez pour eux', 'Votez pour eux !', '0000-00-00'),
(3, 'JJ Rousseau', 'Pulpa Colada3', 'C''est les meilleurs votez pour eux', 'Votez pour eux !', '0000-00-00'),
(4, 'JJ Rousseau', 'Pulpa Colada4', 'C''est les meilleurs votez pour eux', 'Votez pour eux !', '0000-00-00'),
(5, 'JJ Rousseau', 'Pulpa Colada5', 'C''est les meilleurs votez pour eux', 'Votez pour eux !', '0000-00-00');
...
(5, 'titi', 'toto', '11111111', 'titi@toto.fr', 2000, 'MEMBRE', 1),
...
--
ALTER TABLE `articles`
  MODIFY `ID_ART` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
